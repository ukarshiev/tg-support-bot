<div class="p-4 lg:p-8">
    ...
    {{-- ── Page header ──────────────────────────────────────────────────────────── --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-text-primary">Редактирование участника</h1>
        <p class="mt-1 text-sm text-text-secondary">Измените данные оператора, роль или пароль</p>
    </div>
    ...
    <div class="rounded-xl border border-border-light bg-bg-primary p-4 lg:max-w-2xl lg:p-6">
        ...
        <div class="space-y-5">
            ...
            {{-- Password (optional) --}}
            <x-admin.form-field label="Новый пароль" for="password" hint="Оставьте пустым, чтобы не менять. Не короче 8 символов." :error="$errors->first('password')">
                <input
                    id="password"
                    type="password"
                    wire:model="password"
            ...
            <x-admin.form-field label="Подтверждение пароля" for="password_confirmation">
                <input
